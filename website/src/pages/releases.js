...
function createFeaturedCard(release, label) {
  ...
  div.innerHTML = `
    ...
    <div class="markdown-content" style="margin: 1.5rem 0; color: var(--text-dim); font-size: 0.95rem; height: 300px; overflow-y: auto; padding-right: 1rem; background: rgba(0,0,0,0.2); padding: 1rem; border-radius: 8px; border: 1px solid var(--border-color);">
      ${marked.parse(release.body.trim())}
    </div>
        ...
        <div class="container">
          ...
          <div style="display: flex; flex-direction: column; gap: 3rem;">
            ...
            <div>
              ...
              <div class="markdown-content" style="background: var(--card-bg); padding: 3rem; border-radius: 12px; border: 1px solid var(--border-color); line-height: 1.8;">
                ${marked.parse(release.body.trim())}
              </div>
            </div>
          </div>
